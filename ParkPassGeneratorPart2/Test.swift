...
//        do {
//            let pass = try GuestPass(entrant: guestEntrant, guestTypeString: GuestType.adult.rawValue)
//            testPass(pass: pass)
//        } catch(let error) {
//            print(error)
//        }
...
//        do {
//            let pass = try GuestPass(entrant: guestEntrant, guestTypeString: GuestType.vip.rawValue)
//            testPass(pass: pass)
//        } catch(let error) {
//            print(error)
//        }
...
//        do {
//            let pass = try GuestPass(entrant: childGuestEntrant, guestTypeString: GuestType.child.rawValue)
//            testPass(pass: pass)
//        } catch GeneratorError.missingInformation(let description){
//            print(description)
...
//        do {
//            let pass = try GuestPass(entrant: guestEntrantBirthday, guestTypeString: GuestType.adult.rawValue)
//            testPass(pass: pass)
//        } catch(let error) {
//            print(error)
//        }
...
//        do {
//            let pass = try GuestPass(entrant: guestEntrantAdult, guestTypeString: GuestType.child.rawValue)
//            testPass(pass: pass)
//        } catch GeneratorError.missingInformation(let description){
//            print(description)
//        } catch GeneratorError.olderThanFive(let description) {
...
//        do {
//            let pass = try GuestPass(entrant: guestEntrant, guestTypeString: GuestType.child.rawValue)
//            testPass(pass: pass)
//        } catch GeneratorError.missingInformation(let description){
//            print(description)
//        } catch GeneratorError.olderThanFive(let description) {
